...
SECRET_KEY = 'django-insecure-d0_7e4_1h@2)pmq*)j)35u0u^^tkqz2ple8cqux304@5+kgrj!'
...
AUTH_USER_MODEL = 'moneyhouse.CustomUser'

AUTHENTICATION_BACKENDS = [
    'moneyhouse.backends.PhoneBackend',
...
EMAIL_HOST_PASSWORD = 'acuf mtbf lnco vgkk'   # your app password
